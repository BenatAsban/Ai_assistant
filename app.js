...
window.addEventListener('load', ()=>{
    speak("welcomeback sir. all system for searching will be prepared in few minutes. for now feel free to grab a cub of coffee and have a good day");
    wishMe("");
})
...
function speakThis(message) {
    ...
    if(message.includes('hi') || message.includes('hello')) {
        ...
        const finalText = "hi sir. how are you. have a nice day.";
        speech.text = finalText;
    }
        ...
        const finalText = "I'm a virtual assistant. My name is jarvis. I'm developed by benat. I can help you that you want. Still I'm under devloping. I think I'll be more powerful with benat. Thank You";
        speech.text = finalText;
    }

    else if(message.includes('how old are you')) {
        const finalText = "As I'm a virtual assistant, I've no age. But, i can say that I've started my journey from 10th june, 2000";
        speech.text = finalText;
    }
        ...
        const finalText = "I'm developed by benat. Let see his profile";
        window.open("https://github.com/BenatAsban", "_blank");
        speech.text = finalText;
    }
